...
public class UserRegistrationEmailFormatter implements EmailFormatter{

    private static final String SUBJECT = "%s - verificación de cuenta.";
    private static final String VERIFICATION_CODE_VARIABLE = "verificationCode";
    private static final String LINK = "link";
    private static final String EMAIL_TEMPLATE = "email/auto-registration-verification";
    ...
    public String getContent(SpringTemplateEngine templateEngine) {
        ...
        context.setVariable(LINK, generateLink());
        return templateEngine.process(EMAIL_TEMPLATE, context);
    }

    private String generateLink() {
        return String.format("%s/sign-up?email=%s&verificationCode=%s&showpass=false",host, user.getEmail(), user.getVerificationCode());
    }
}
